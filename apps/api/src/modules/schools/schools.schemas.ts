...
export const updateSchoolSchema = z.object({
  ...
  zipCode: z.preprocess(emptyToUndefined, z.string().max(9).optional()),
  street: z.preprocess(emptyToUndefined, z.string().max(200).optional()),
  number: z.preprocess(emptyToUndefined, z.string().max(20).optional()),
  complement: z.preprocess(emptyToUndefined, z.string().max(100).optional()),
  neighborhood: z.preprocess(emptyToUndefined, z.string().max(100).optional()),
