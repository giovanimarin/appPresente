...
export default function EditStudentPage() {
  ...
  const { register, handleSubmit, reset, watch, setValue, control, formState: { errors, isSubmitting, isDirty } } = useForm<FormData>({ resolver: zodResolver(schema) });
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              inputMode="numeric"
              className={cn('w-full px-3 py-2.5 rounded-lg border text-sm focus:ring-2 focus:ring-primary-500 focus:outline-none', errors.cpf ? 'border-red-300' : 'border-gray-300')}
            />
